...
class AlienAttack:
    def __init__(self):
        ...
        self.easy_button = Button(self, self.settings.screen_width//2 - 100, 150, (102, 255, 0), "Easy")
        self.normal_button = Button(self, self.settings.screen_width//2 - 100, 350, (255, 216, 0), "Normal")
        self.hard_button = Button(self, self.settings.screen_width//2 - 100, 550, (255, 36, 0), "Hard")
        self.zerout_record_button = Button(
            self, self.settings.screen_width//2 - 100, 650, (0, 0, 0), "Zero out a record")
